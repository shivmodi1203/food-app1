...
const DBNewItems = () => {
        ...
        uploadTask.on(
            ...
            () => {
                getDownloadURL(uploadTask.snapshot.ref).then((downloadURL) => {
                    ...
                    setIsLoading(false);
                    setProgress(null);
                    dispatch(alertSuccess("Image is Uploaded Successfully"));
                    setTimeout(() => {
                        dispatch(alertNULL());
                    }, 2000)
                });
    ...
    const deleteImageFromFirebase = (imageDownloadURL) => {
        ...
        deleteObject(deleteRef).then(() => {
            ...
            setIsLoading(false);
            dispatch(alertSuccess("Image is Deleted Successfully"));
            setTimeout(() => {
                dispatch(alertNULL());
            }, 2000)
        })
    ...
    return (
        <div className='flex flex-col justify-center items-center px-24 pt-6 w-full'>
            <div className='border border-gray-300 rounded-md p-4 w-full flex flex-col justify-center items-center gap-4'>
                ...
                <InputValueField
                    ...
                    stateValue={price}
                />
                <div className='w-full bg-card backdrop-blur-md h-370 rounded-md border-2 border-dotted bordergra300 cursor-pointer'>
                    {isLoading ? (
                            ...
                            {Math.round(progress > 0)  && (
                                <div className='w-full flex flex-col items-center justify-center gap-2'>
                                    ...
                                    <div className='w-full bg-gray-200 rounded-full h-2.5'>
                                        <div className='bg-red-600 rounded-full h-2.5 transition-all duration-300 ease-in-out'
