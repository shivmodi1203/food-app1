        ...
        <motion.div className="w-full grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="flex flex-col items-start justify-start gap-6">
                ...
                <p className="text-textColor text-lg">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Aperiam quisquam expedita dolor iste nisi similique, deserunt rem maiores sit, animi officia cupiditate quo quos dicta nulla at sed pariatur corrupti eos? Excepturi soluta laborum, ab fuga dignissimos nesciunt nihil ex placeat nam, aliquid praesentium perspiciatis quibusdam ducimus itaque minus quia!
                </p>
                    ...
                    {randomData && randomData.map((data,i) => (
                        <motion.div key={i} {...staggerFadeInOut(i)} className="w-32 h-36 md:h-auto md:w-190 p-4 bg-cardOverlay backdrop-blur-md rounded-3xl flex flex-col items-center justify-center drop-shadow-lg">        
                            ...
                            <p className="text-lg font-semibold text-headingColor">
                                <span className="text-lg text-red-600">₹</span>{" "}{data.product_price}
                            </p>
